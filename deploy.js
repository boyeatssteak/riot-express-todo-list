...
function cloneRepo() {
  ...
  cmd.get(
    'rm -rf riot-express-todo-list && git clone https://github.com/woz-u/riot-express-todo-list',
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function(result) {
      console.log("pre transferProjectToRemote");
      const failed = [];
      const successful = [];
      if (result.stdout) {
    ...
    .then(function(status) {
      console.log('pre stopRemoteServices');
      if (status) {
        console.log('successful');
    ...
    .then(function(status) {
      console.log('pre updateRemoteApp');
      if (status) {
        console.log('successful');
    ...
    .then(function(status) {
      console.log('pre restartRemoteServices');
      if (status) {
        console.log('successful');
